...
setwd("/Users/sachinsubedi/Library/CloudStorage/OneDrive-UniversityofGeorgia/EU_H5/feb13/Results/GLM_Habitat/")
# Define a mapping from varID to descriptive names from the XML
var_name_mapping <- c(
  "1" = "Case Count Origin",
  "2" = "Case Count Destination",
  "3" = "Sample Size Origin",
  "4" = "Sample Size Destination"
)
...
dirname <- "/Users/sachinsubedi/Library/CloudStorage/OneDrive-UniversityofGeorgia/EU_H5/feb13/Results/GLM_Habitat/"
